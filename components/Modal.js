...
export default function Modal({children, open, setOpen, innerRef}) {

  
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" initialFocus={innerRef} onClose={setOpen}>
